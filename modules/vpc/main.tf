...
resource "aws_subnet" "public-1" {
  ...
  tags = {
    Name = "${var.app_name}-${var.region}-${var.environment}-public_subnet_1"
  }
}
resource "aws_subnet" "public-2" {
  ...
  tags = {
    Name = "${var.app_name}-${var.region}-${var.environment}-public_subnet_2"
  }
}
resource "aws_subnet" "public-3" {
  ...
  tags = {
    Name = "${var.app_name}-${var.region}-${var.environment}-public_subnet_3"
  }
}
